    ...
    "node_modules/big.js/big.js"(exports, module) {
      (function(global) {
        ...
        function bigFactory() {
          function Big2(n) {
            ...
            if (!(x instanceof Big2)) {
              return n === void 0 ? bigFactory() : new Big2(n);
            }
        ...
        function format(x, dp, toE) {
          var Big2 = x.constructor, i = dp - (x = new Big2(x)).e, c = x.c;
          if (c.length > ++dp) {
            rnd(x, i, Big2.RM);
          }
          if (!c[0]) {
          ...
          i = x.e;
          return toE === 1 || toE && (dp <= i || i <= Big2.E_NEG) ? (
        ...
        P.div = function(y) {
          var x = this, Big2 = x.constructor, dvd = x.c, dvs = (y = new Big2(y)).c, s = x.s == y.s ? 1 : -1, dp = Big2.DP;
        ...
        P.round = function(dp, rm) {
          ...
          rnd(x = new Big2(x), dp, rm == null ? Big2.RM : rm);
          return x;
        };
        P.sqrt = function() {
          var estimate, r, approx, x = this, Big2 = x.constructor, xc = x.c, i = x.s, e = x.e, half = new Big2("0.5");
          if (!xc[0]) {
            return new Big2(x);
          }
          if (i < 0) {
          ...
          if (i === 0 || i === 1 / 0) {
            ...
            r = new Big2(Math.sqrt(estimate).toString());
            r.e = ((e + 1) / 2 | 0) - (e < 0 || e & 1);
          } else {
            r = new Big2(i.toString());
          }
          i = r.e + (Big2.DP += 4);
          do {
            approx = r;
        ...
        P.toString = P.valueOf = P.toJSON = function() {
          var x = this, Big2 = x.constructor, e = x.e, str = x.c.join(""), strL = str.length;
          if (e <= Big2.E_NEG || e >= Big2.E_POS) {
        ...
        P.toFixed = function(dp) {
          var str, x = this, Big2 = x.constructor, neg = Big2.E_NEG, pos = Big2.E_POS;
          Big2.E_NEG = -(Big2.E_POS = 1 / 0);
          if (dp == null) {
            str = x.toString();
          } else if (dp === ~~dp && dp >= 0 && dp <= MAX_DP) {
            str = format(x, x.e + dp);
